...
#   - سایر موارد (دادخواست، دعاوی اعتراضی، اعلام وکالت و ...): ۲۰۰ تومان
PREPAY_LAYEHE_EIZARNAMEH_TOMAN = 100   # تومان → ۱,۰۰۰ ریال
PREPAY_OTHER_SERVICES_TOMAN = 200      # تومان → ۲,۰۰۰ ریال
